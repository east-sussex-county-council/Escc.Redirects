...
$projectName = "Escc.Redirects.Admin" 
...
robocopy $sourceFolder "$destinationFolder/$projectName" /MIR /IF *.aspx *.dll *.css csc.* csi.* /XD aspnet_client obj Properties App_Start
...
TransformConfig "$sourceFolder\edit\web.example.config" "$destinationFolder\$projectName\edit\web.config" "$transformsFolder\$projectName\edit\web.release.config"
if (Test-Path "$transformsFolder\$projectName\edit\web.$websiteName.config") {
	TransformConfig "$destinationFolder\$projectName\edit\web.config" "$destinationFolder\$projectName\edit\web.temp1.config" "$transformsFolder\$projectName\edit\web.$websiteName.config"
	copy "$destinationFolder\$projectName\edit\web.temp1.config" "$destinationFolder\$projectName\edit\web.config"
	del "$destinationFolder\$projectName\edit\web.temp1.config"
}
